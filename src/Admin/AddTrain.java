    ...
    private void btnaddtrainActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnaddtrainActionPerformed
        ...
        if(verifyTrains()){
            ...
            try {
                ...
                AddTrain train=new AddTrain(tNum,tName,StartStation,StopStation,StartTime,StopTime,NOSFirst,NOSSecond,NOSSleeper,FareFirst,FareSecond,FareSleeper,rundays);
                String Res=addt.addtrain(train);
                if(Res.equals("valid")){
